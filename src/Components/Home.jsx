      ...
      <div className="noise"/>
        <div className="grid grid-cols-3 gap-2 md:grid-cols-4 md:gap-4 my-5 container mx-auto xl:px-20">
          ...
          <div className="h-full  absolute  p-4 md:p-8 flex flex-col justify-start  md:justify-end">
            ...
            <img className="w-32 h-32 mb-4 rounded-full dark:bg-gray-500 aspect-square" src={aditya} alt="" />
...
{/* LINKEDIN BUTTON */}
<a
href="https://www.linkedin.com/in/aditya-nagre-94a758213/"
target="_blank"
...
>
  <path d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
          ...
          {/* EMAIL BUTTON */}
          <a
            href="mailto:adxtyacp@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Email"
          ...
          {/* GITHUB BUTTON */}
          <a
  href="https://github.com/AdityaNagre"
  target="_blank"
  rel="noopener noreferrer"
...
>
  ...
  <path d="M19 19H5V5h7V3H5a2 2 0 00-2 2v14a2 2 0 002 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z" />
    ...
    <h2 className="font-bold text-md md:text-xl lg:text-4xl">Projects</h2>
    ...
    <div className="w-full h-full bg-black absolute">
      ...
      />
          ...
          {/* TWITTER BUTTON */}
          <a
            href="https://x.com/adytyx?t=LCCHytv8wnMwl_pfIVfuBw&s=09"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Twitter"
          ...
          {/* INSTAGRAM BUTTON */}
          <a
            href="https://instagram.com/adityanagre_?igsh=MWFmaGo1ZnBncnFmNA=="
            target="_blank"
            rel="noopener noreferrer"
      ...
      <p class="flex justify-center text-sm text-white text-center my-4">Designed and Coded by&nbsp;<a href="https://enjae.netlify.app/" class="hover:underline"> enjae™</a>🌸</p>
